...
RESPONSES = {
    "en": {
        ...
        "no_service_mapping": "No app mapping for {service} on {device}.",
        "launch_failed": "Could not open {service} on {device}.",
        "control_sent": "OK.",
    ...
    "sv": {
        ...
        "no_service_mapping": "Ingen app-mappning för {service} på {device}.",
        "launch_failed": "Kunde inte öppna {service} på {device}.",
        "control_sent": "Okej.",
